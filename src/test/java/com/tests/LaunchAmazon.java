...
public class LaunchAmazon extends LibraryFunctions{
	@Test(priority= -1)
	public void VisitAmazon() {
		driver.navigate().to(ObjProperties.getProperty("amazonUrl"));
	...
	public void ValidatePageTitle() {
		...
		Assert.assertEquals(pageTilte, ObjProperties.getProperty("amazonTitle"));
	} 
	@BeforeMethod
